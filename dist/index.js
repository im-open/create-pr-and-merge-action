...
var baseBranch = core.getInput('base-branch', requiredArgOptions);
var headBranch = core.getInput('head-branch', requiredArgOptions);
var repoName = core.getInput('repository-name') || github.context.repo.repo;
var ownerName = core.getInput('owner-name') || github.context.repo.owner;
var prTitle = core.getInput('pr-title', requiredArgOptions);
var gitHubToken = core.getInput('github-token', requiredArgOptions);
var patToken = core.getInput('pat-token', requiredArgOptions);
async function run() {
